...
import com.example.cursomvc.domain.*;
...
//		--------------------------------------------------------------
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "isaquerocha@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCrypt.encode("123456"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "isaque.santos@ufes.br", "40758972067", TipoCliente.PESSOAFISICA, bCrypt.encode("123456"));
        cli2.addPerfil(Perfil.ADMIN);
        cli1.getTelefones().addAll(Arrays.asList("98363323", "99838393"));


        Endereco e1 = new Endereco(null, "Rua das Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Floriano", "2106 ", null, "Centro", "38777010", cli2, c2);
